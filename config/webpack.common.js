...
// var fontAwesomePath = require('../node_modules/font-awesome/scss/font-awesome.scss');
const buildUtils = require('./build-utils');
const bootstrapEntryPoints = require('./webpack.bootstrap.config.js');

// const fontAwesomePath = require("font-awesome-webpack");
/**
...
module.exports = function (options) {
  ...
  const entry = {
    fontawesome: 'font-awesome-sass-loader!./font-awesome-sass.config.js',
    polyfills: './src/polyfills.browser.ts',
    bootstrapDevEntryPoint: bootstrapEntryPoints["dev"],
